INSERT INTO CFG (TMCODIGO, TIPO, NOME, PROPRIETARIO, NIVEL, VALOR, DESCRICAO, VALIDA) VALUES (0, 'TRIBUTO', 'ALIQUOTA CBS', 1, '2', '0', 'ALIQUOTA DO CBS, DEFINDA NO AMBITO NACIONAL', '<N4,2>');
...
ALTER TABLE NFCI ADD CLASTRIBIBSCBS CHAR(6) DEFAULT '000000',
                 ...
                 ADD TXIS NUMERIC(9,4) DEFAULT 0,
                 ADD TXIBSUF NUMERIC(9,4) DEFAULT 0,
                 ADD TXIBSMUN NUMERIC(9,4) DEFAULT 0,
                 ADD TXCBS NUMERIC(9,4) DEFAULT 0;

CREATE TABLE CLASSTRIBNCM (
    ID           CHAR(6) DEFAULT '000000' NOT NULL,
    NCM          CHAR(8) DEFAULT '00000000' NOT NULL,
    VIGENCIADE   DATE,
    VIGENCIAATE  DATE,
    CONSTRAINT CLASSTRIBNCMPK PRIMARY KEY (ID, NCM)
);
...
INSERT INTO TIPODEBITOCREDITONFE (ID, DEBCRED, DESCRICAO) VALUES (4,'D','Multa e juros; 05=Transferência de crédito na sucessão');
INSERT INTO TIPODEBITOCREDITONFE (ID, DEBCRED, DESCRICAO) VALUES (6,'D','Pagamento antecipado');
INSERT INTO TIPODEBITOCREDITONFE (ID, DEBCRED, DESCRICAO) VALUES (7,'D','Perda em estoque; 08=Desenquadramento do SN');
